	...
	<nav class="navbar navbar-expand-lg navbar-light shadow">
		<div
			...
			<a class="navbar-brand text-success logo h1 align-self-center"
				href="./"> <img src="./resources/images/logo.PNG" width="200px">
			...
			<div
				...
				<div class="flex-fill">
					<ul
						...
						<li class="nav-item"><a class="nav-link" href="./m_myPage">FLOWER</a>
						</li>
						<li class="nav-item"><a class="nav-link" href="./m_joinFrm">DAY COUNTER</a>
						</li>
						<li class="nav-item"><a class="nav-link" href="./m_loginFrm">NOTICE</a>
						</li>
						<li class="nav-item"><a class="nav-link" href="./mypage">MY PAGE</a>
						</li>
					</ul>
				</div>
